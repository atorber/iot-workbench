<template>
  <PageWrapper title="设备ID：234231029431" contentBackground>
    <template #headerContent> <DeviceDetailHeader /> </template>
    <!-- <template #extra>
    ...
    <template #footer>
      <a-tabs default-active-key="1">
        <a-tab-pane key="1" tab="设备状态" />
        <a-tab-pane key="2" tab="设备影子" />
        <a-tab-pane key="3" tab="接口列表" />
        <a-tab-pane key="4" tab="数据解析" />
        <a-tab-pane key="5" tab="设备日志" />
      </a-tabs>
    </template>
